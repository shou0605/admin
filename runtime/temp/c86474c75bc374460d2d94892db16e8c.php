<?php /*a:4:{s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\index\index.html";i:1578676881;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1554390875;s:72:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\menu.html";i:1579172141;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1482856936;}*/ ?>
﻿<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="">o2o平台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href=""></a> <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li>您好,</li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"><?php echo session('admin.username'); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="myinfo_edit('个人信息','<?php echo url("myinfo"); ?>','','400')">个人信息</a></li>
							<!--<li><a href="#">切换账户</a></li>-->
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<?php echo htmlspecialchars_decode($index_menu); ?>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="<?php echo url('system'); ?>" style="line-height: ">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo url('system'); ?>"></iframe>
		</div>
	</div>
</section>
<!--包含菜单文件-->
...
<script>
	$(function(){
		...
		//换肤初始值
		var v = "<?php echo session('admin.color_type'); ?>";
		setCookie("Huiskin", v);
		...
		$('#Hui-skin .box-shadow a').click(function(){
			$.ajax({
				url: "<?php echo url('skin_peeler'); ?>",
				type: "post",
				dataType: "json",
				data: {
					'color_type':$(this).attr("color-type"),
					'id':<?php echo session('admin.uid') ? session('admin.uid') : 0; ?>,
				},
