<?php /*a:3:{s:75:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\auth\auth_edit.html";i:1579169379;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1554390875;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1482856936;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="#" id="myinfoup" method="POST" class="form form-horizontal" role="form" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['description']); ?>" placeholder=""   name="description">
            </div>
        </div>
...
<script>
    ...
    $("#myinfoup").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url: "<?php echo url('auth_edit'); ?>" ,  /*这是处理文件上传的servlet*/
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
