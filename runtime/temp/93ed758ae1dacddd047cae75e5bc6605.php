<?php /*a:3:{s:76:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\admin\user_edit.html";i:1579004626;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1554390875;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1482856936;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form action="#" id="myinfoup" method="POST" class="form form-horizontal" role="form" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['username']); ?>" placeholder=""  disabled  name="username">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['nickname']); ?>" placeholder=""   name="nickname">
            </div>
        </div>
        ...
        submitHandler:function(form){
            ...
            if(inpt_pass!=''){
                if(inpt_pass !== inpt_repass){
                    ...
                    return false;
                }else if(inpt_pass.length<6 || inpt_pass.length>13){
                    layer.msg('密码需长度6-13位',{icon:2});
                    return false;
                }
            }

            $.ajax({
                url: "<?php echo url('user_edit'); ?>" ,  /*这是处理文件上传的servlet*/
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
