<?php /*a:3:{s:73:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\index\myinfo.html";i:1579004726;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1554390875;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1482856936;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
    ...
    <form action="#" id="myinfoup" method="POST" class="form form-horizontal" role="form" >
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo session('admin.username'); ?>" placeholder="" disabled  name="username">
            </div>
        </div>
...
<script>
    $("#myinfoup").validate({
        ...
        submitHandler:function(form){
            ...
            $.ajax({
                url: "<?php echo url('index/myinfo'); ?>" ,  /*这是处理文件上传的servlet*/
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
