<?php /*a:3:{s:75:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\auth\auth_list.html";i:1579169427;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1554390875;s:74:"D:\phpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1482856936;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 开发管理 <span class="c-gray en">&gt;</span> 权限列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>

<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray">
        <a href="javascript:;" onclick="layer_show('添加权限组','<?php echo url("auth_add"); ?>','','600')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加</a>
    ...
    <div class="">
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr class="text-c">
                ...
                <td><a href="<?php echo url('menu_list',['pid'=>$v['id']]); ?>"><?php echo htmlentities($v['title']); ?></a></td>
                ...
                <td class="td-manage">
                    <a style="text-decoration:none" class="ml-5" onClick="layer_show('编辑','<?php echo url("auth_edit",["id"=>$v["id"]]); ?>','','600')" href="javascript:;" title="编辑">
